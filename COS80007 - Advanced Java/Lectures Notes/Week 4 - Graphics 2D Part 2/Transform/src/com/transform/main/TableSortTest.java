...
/**
This table model takes an existing table model and produces a new
model that sorts the rows
   ...
   in the sort column.
	...
	private class Row implements Comparable<Row>
	{
		...
		public int compareTo(Row other)
		{
			...
			Object b = model.getValueAt(other.index, sortColumn);  // 4-Aug-05
			if (a instanceof Comparable)
				return ((Comparable) a).compareTo((Comparable)b);  // 4-Aug-05
			else
