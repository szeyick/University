 ...
 * <p>
 * This class is responsible for managing all the car instances that are
 * within the Automatic Parking Simulator. It maintains a collection of 
 * {@link CarModel} that will indicate which car is on which floor. In 
 * addition, for cars that are being moved around the car park, it will
 * manage the single instance of it.
 * <p>
 * @author szeyick
 */
public class CarModelManager {
    ...
    /**
     * A collection that will map the car models to the floor that
     * they appear on.
     */
