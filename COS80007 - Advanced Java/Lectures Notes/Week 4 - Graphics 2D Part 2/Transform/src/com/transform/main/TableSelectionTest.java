...
/**
This program demonstrates selection, addition, and removal of
rows and columns.
 */
...
/**
This frame shows a multiplication table and has menus for setting
the row/column/cell selection modes, and for adding and removing 
rows and columns.
 */
