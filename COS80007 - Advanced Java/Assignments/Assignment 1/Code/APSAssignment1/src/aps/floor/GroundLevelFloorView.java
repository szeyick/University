 ...
 * <p>
 * This class will generate the ground floor off a configuration and return
 * a shape object that will represent the floor that cars will enter/exit.
 * <p>
 * @author szeyick
 * StudentID - 1763652
 */
public class GroundLevelFloorView {
    ...
    /***
     * Read the input from an external file and plot
     * the shape.
     */
    private void initialiseFloorPlan() {
        int lineNumber = 0;
        try {
            FileReader fileReader = new FileReader("floorplan_data.txt");
